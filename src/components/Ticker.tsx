...
const Ticker = () => (
  <div className="bg-dark overflow-hidden h-10 flex items-center border-b-2 border-primary">
    <div className="flex whitespace-nowrap ticker-animate">
      {[...items, ...items].map((item, i) => (
        <span key={i} className="text-xs font-semibold tracking-[0.18em] uppercase px-7 text-white/35">
