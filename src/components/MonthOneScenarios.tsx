  ...
  <section>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
      ...
      <div className="bg-card border-2 border-primary p-7 shadow-md card-lift relative">
        <span className="absolute top-[18px] right-[18px] text-[9px] font-bold tracking-[0.1em] uppercase px-[10px] py-1 bg-primary text-white">Recommended</span>
        <div className="text-[9px] font-bold tracking-[0.15em] uppercase text-ash mb-3">Scenario A</div>
        <div className="font-serif text-[54px] font-bold text-ink leading-none mb-1 tracking-tight">$30,000</div>
        <div className="text-[11px] text-ash mb-5">Month one target</div>
        {[
          ...
          <div key={i} className="flex justify-between items-center py-[9px] border-b border-border text-xs text-charcoal last:border-b-0">
      ...
      <div className="bg-card border border-border p-7 shadow-sm card-lift">
        <div className="text-[9px] font-bold tracking-[0.15em] uppercase text-ash mb-3">Scenario B — High-Ticket Mix</div>
        <div className="font-serif text-[54px] font-bold text-ink leading-none mb-1 tracking-tight">$30,000</div>
        <div className="text-[11px] text-ash mb-5">Month one target</div>
        {[
      ...
      {/* Scenario C */}
      <div className="bg-card border border-border p-7 shadow-sm card-lift">
        <div className="text-[9px] font-bold tracking-[0.15em] uppercase text-ash mb-3">Scenario C — Three Retainers</div>
        ...
        <p className="text-[11px] text-ash italic mt-3 leading-[1.6]">240 billable hours per month. Evaluate bandwidth before committing to all three simultaneously.</p>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
      {[
        ...
        { num: "Equity", label: "Tech Advisory Upside", note: "Two to five percent equity in a funded workforce tech company. Not a consulting deal. A wealth-building play that compounds on knowledge you already hold." },
      ].map((item, i) => (
        <div key={i} className="bg-card border border-border p-[22px] shadow-sm card-lift">
          ...
          <div className="text-[9px] font-bold tracking-[0.12em] uppercase text-ash mb-2">{item.label}</div>
          <p className="text-xs text-ash leading-[1.65]">{item.note}</p>
        </div>
      ))}
    </div>
  </section>
