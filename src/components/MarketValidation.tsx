...
const MarketValidation = () => (
  <section>
    <SectionHeader
      ...
      subtitle="A second strategic review by Manus AI confirmed this blueprint and added one critical piece: the VIP Grant Strategy Day is standard market rate. Here is the data."
    />
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-7">
      {[
        ...
        <div key={i} className="bg-card border border-border p-8 text-center shadow-sm card-lift">
          ...
          <div className="text-[9px] font-bold tracking-[0.16em] uppercase text-ash mb-3">{item.label}</div>
          <p className="text-[13px] text-ash leading-[1.72]">{item.body}</p>
        </div>
      ))}
    </div>
    ...
    <div className="bg-dark p-10 grid grid-cols-1 md:grid-cols-2 gap-11 items-center mb-7">
      <div>
        <div className="text-[9px] font-bold tracking-[0.18em] uppercase text-primary mb-3">The Real Frame</div>
        ...
        <p className="text-[13px] text-white/[0.42] leading-[1.8]">
